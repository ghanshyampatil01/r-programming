...
plot(airquality) #scatterplot- tells linear relationship between  two numeric 
help(plot)
...
boxplot.stats(airquality$Wind)$out # stas function - outlier values
...
min(airquality$Solar.R,na.rm=T) #use na.rm=T for getting output even with the na values 
